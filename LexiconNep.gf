...
--open ResPnb, Prelude in {
  ...
  beg_V2V =  mkV2V (compoundV "आर्गह" do_V2) lai "" False ;
  big_A = mkA "ठुलो" ; -- ठुलो
  -- bike_N = mkN0103 "सायछल" ;
  bird_N = regN "चरा" ; -- चरा
  ...
  -- brother_N2 = mkN012 (mkN0101 "परा") (mkPrep "का") "कै" ; --not correct
  ...
  -- distance_N3 = mkN013 (mkN01 "पयनधा") (mkPrep "दा") "दै" "तौण"  ;
  ...
  -- mother_N2 = mkN2 (mkNF "आमा") (mkPrep "दय") "धै";   -- not covered need to be discussed  
  mother_N2 = mkN2 (mkNF "आमा") (mkPrep "को") "";   -- need ko discuss
   -- what if mother comes at the begining of sentence
  ...
  paint_V2A = mkV2 (compoundV "रनग" (mkV2 (mkV "लागाउनु"))) "लाइ" ; 
  ...
  --seek_V2 = mkV2 (mkV "लबh'ना" ) "नौण" ;
  seek_V2 = mkV2 (mkV "खोज्नु" ) ;
  -- see_V2 = mkV2 (mkV "ौयकh'ना") "नौण" ; -- deKx:nu -- देख्नु
  -- sell_V3 = mkV3 (mkV "ौयछना") "कौ" ""; -- beCx:nu -- बेच्नु
  -- send_V3 = mkV3 (mkV "पयजना") "कौ" ""; -- pQafnu  -- पठाउनु
  see_V2 = mkV2 (mkV "देख्नु") "लाई" ; -- deKx:nu -- देख्नु
  sell_V3 = mkV3 (mkV "बेच्नु") "" "लाई" ; --  बेच्नु ???? ram(le) sita (lai) kitab bachyo
  send_V3 = mkV3 (mkV "पठाउनु") "कौ" ""; -- pQafnu  -- पठाउनु ????
  ...
  -- switch8off_V2 = mkV2 (mkV "छलाना") ; ????
  -- switch8on_V2 = mkV2 (compoundV "बनद" do_V2) ; ????
  table_N = regN "टेबल" ; -- टेबल
  talk_V3 = mkV3 (compoundV "कुरा" (mkV2 (mkV "गर्नु"))) "सँग" ""; -- kura -- कुरा गर्नु ???? how does it works
  ...
  tree_N = regN "रुख" ; -- रुख
  trousers_N = regN "ट्राउजर" ; -- ट्राउजर
  ...
  -- wait_V2 = mkV2 (compoundV "राह" (mkV "ौयकh'ना")) ; -- prx:Knu पर्खनु -- not covered bu rule
  ...
  -- now_Adv = mkAdv "हौण" ;
  -- already_Adv = mkAdj1dv "पहलE?हय" ;
  song_N = regN "गीत" ; -- गित
  add_V3 = mkV3 (mkV "जोड्नु") "सँग" "" ; -- joxx:nu -- जोड्नु
  number_N = regN "संख्या" ; -- संख्या
  put_V2 = mkV2 (mkV "राख्नु") ; -- राख्नु
  stop_V = mkV "रोक्नु" ; -- रोक्नु
  --jump_V = mkV "उफ्रनु" ; -- उफ्रनु 
  -- left_Ord = {s = "सजा" ; n = singular}; -- ????
  -- right_Ord = {s= "कh'बा" ; n = singular}; -- ????
  -- far_Adv = mkAdj1dv "दौर" ;
  ...
  -- guts_N = mkN01 "g?त" ; -- FIXME: no singular
  ...
  --lie_V = compoundV "झुट" (mkV "बोल्नु" ); -- झुट बोल्नु
