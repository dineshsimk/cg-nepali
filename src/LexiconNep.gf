...
--open ResPnb, Prelude in {
  ...
  beg_V2V =  mkV2V (compoundV "Arx:gh" do_V2) lai "" False ;
  big_A = mkA "Qulo" ; -- ठुलो
  -- bike_N = mkN0103 "saycl" ;
  bird_N = regN "Cra" ; -- चरा
  ...
  -- brother_N2 = mkN012 (mkN0101 "pra") (mkPrep "ka") "kE" ; --not correct
  ...
  -- distance_N3 = mkN013 (mkN01 "pynDa") (mkPrep "da") "dE" "twN"  ;
  ...
  -- father_N2 = mkN012 (mkN0101 "aba") (mkPrep "da") "dE"  ; --- HOW IT WORKS
  fear_VS = mkV "xrafnu"; -- डराउनु
  find_V2 = mkV2 (mkV "pafnu") ; -- पाउनु
  fish_N = regN "maca" ; -- माछा
  floor_N = regN "BuVI:" ; -- भुँई
  --forget_V2 = mkV2 (mkV "birx:snu") ; -- बिर्सनु       ???? NOT COVERED BY RULE
  ...
  -- mother_N2 = mkN2 (mkNF "Ama") (mkPrep "dy") "DE";   -- not covered need to be discussed  
  ...
  paint_V2A = mkV2 (compoundV "rng" (mkV2 (mkV "lagafnu"))) "lai:" ; 
  ...
  -- see_V2 = mkV2 (mkV "wykh'na") "nwN" ; -- deKx:nu -- देख्नु
  -- sell_V3 = mkV3 (mkV "wycna") "kw" ""; -- beCx:nu -- बेच्नु
  -- send_V3 = mkV3 (mkV "pyjna") "kw" ""; -- pQafnu  -- पठाउनु
  see_V2 = mkV2 (mkV "deKx:nu") "laI:" ; -- deKx:nu -- देख्नु
  sell_V3 = mkV3 (mkV "beCx:nu") "" "laI:" ; --  बेच्नु ???? ram(le) sita (lai) kitab bachyo
  send_V3 = mkV3 (mkV "pQafnu") "kw" ""; -- pQafnu  -- पठाउनु ????
  ...
  talk_V3 = mkV3 (compoundV "kura" (mkV2 (mkV "grx:nu"))) "sVg" ""; -- kura -- कुरा गर्नु ???? how does it works
  ...
  tree_N = regN "ruK" ; -- रुख
  trousers_N = regN "qx:rafjr" ; -- ट्राउजर
  ...
  -- wait_V2 = mkV2 (compoundV "rah" (mkV "wykh'na")) ; -- prx:Knu पर्खनु -- not covered bu rule
  ...
  song_N = regN "gIt" ; -- गित
  add_V3 = mkV3 (mkV "joxx:nu") "sVg" "" ; -- joxx:nu -- जोड्नु
  ...
  -- guts_N = mkN01 "g?t" ; -- FIXME: no singular
  ...
  --lie_V = compoundV "Juq" (mkV "bolx:nu" ); -- झुट बोल्नु
