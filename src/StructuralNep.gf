concrete StructuralNep of Structural = CatNep ** 
  ...
  lin
    ...
    everybody_NP =  MassNP (UseN (regN "svw jana")) ; -- not a good way coz need to include NounPun (सवौ जाना)
...
--  d    first_Ord = {s = "pehla" ; n = Sg} ; --DEPRECATED
    ...
    --how8many_IDet = mkDet "ktI vqa" "ktI vqI" Pl ;  -- काती वटा, कती वटी (incase of mumans it becomes, 'kati jana') NEEDS FIX
    if_Subj = ss "ydi" ; -- यदि
