...
lin num x0 = 
    {s = table {
          NCard =>   x0.s ; 
          NOrd =>  x0.s ++ "wM" -- need to use mkOrd x0.s but it gives linking error 
          };
       n = x0.n
    } ;
...
lin n4 = mkNum "Car" "Calisx:" r4 ;
lin n5 = mkNum "paMC" "pCas" r5 ;
lin n6 = mkNum "c" "saQi'" r6 ; 
lin n7 = mkNum "sat" "satri" r7; 
lin n8 = mkNum "AQ" "Hsi" r8;
lin n9 = mkNum "nw" "nbx:be" r9 ; -- नब्बे
...
oper rows : DSize => DSize => Str = table {
  sg => mkR "gyar" "e:k" "akt" "akt" "akyaw" "ak" "ak" "aky" "aky" ; 
  r2 => mkR "bar"  "" "bat" "bay" "baw" "ba" "ba" "bay" "b" ;
